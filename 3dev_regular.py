...
try:
    p1 = subprocess.Popen('python3 3dev_record.py -a ' + blueberry1 + ' -u '  + userid + ' -r ' + str(runname), shell= True)
    p2 = subprocess.Popen('python3 3dev_record.py -a ' + blueberry2 + ' -u '  + userid + ' -r ' + str(runname), shell= True)
    p3 = subprocess.Popen('python3 3dev_record.py -a ' + blueberry3 + ' -u '  + userid + ' -r ' + str(runname), shell= True)
